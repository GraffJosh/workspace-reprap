  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceTinyg) {
        ...
        console.log("Workspace / Plasma Cutter TinyG just got loaded.", myWorkspaceTinyg);
