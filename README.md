# com-chilipeppr-workspace-tinyg-plasma
This is a workspace for Plasma cutter CNCs running on TinyG.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Plasma Cutter TinyG
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-tinyg-plasma |
| Name                  | Workspace / Plasma Cutter TinyG |
| Description           | This is a workspace for Plasma cutter CNCs running on TinyG. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/openhardwarecoza/workspace-tinyg-plasma/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/openhardwarecoza/workspace-tinyg-plasma |
| Github URL            | http://github.com/openhardwarecoza/workspace-tinyg-plasma |
| Test URL              | https://preview.c9users.io/openhardwarecoza/workspace-tinyg-plasma/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/openhardwarecoza/workspace-tinyg-plasma/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-tinyg-plasma"], // the id you gave your workspace
      function(myWorkspaceTinygPlasma) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Plasma Cutter TinyG just got loaded.", myWorkspaceTinygPlasma);
        myWorkspaceTinygPlasma.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-tinyg-plasma"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Plasma Cutter TinyG"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"This is a workspace for Plasma cutter CNCs running on TinyG."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/openhardwarecoza/workspace-tinyg-plasma/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/openhardwarecoza/workspace-tinyg-plasma"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/openhardwarecoza/workspace-tinyg-plasma"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-tinyg-plasma-openhardwarecoza.c9users.io/workspace.html"</td></tr><tr valign="top"><td>foreignSubscribe</td><td>object</td><td>Please see docs above.</td></tr><tr valign="top"><td>foreignPublish</td><td>object</td><td>Please see docs above.</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
