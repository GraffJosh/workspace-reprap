...
cprequire_test(["inline:com-chilipeppr-workspace-tinyg-plasma"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-tinyg-plasma", ["chilipeppr_ready"], function() {
    return {
        /**
